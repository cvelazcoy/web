...
function LinkFormatter(value, row) {
  ...
  function ChampsActionCommentaire(value, row) {
    var WORKSCOPE_BARCODE = row.WORKSCOPE_BARCODE;
    return '<a id=commentaire href=# onclick=var_code("'+WORKSCOPE_BARCODE+'") title="Commenter"><i class="fa fa-book"></i></a> '+
    '<a id=commentaire href=# onclick=showDialog() title="Commenter"><i class="fa fa-bullhorn"></i></a> '
  }
