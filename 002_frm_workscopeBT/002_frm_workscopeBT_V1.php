...
<head>
  ...
  <script>
    function myAjax(var_visite,var_tache,var_user) {
      $.ajax({
           type: "POST",
           url: 'flag_risque.php',
           data:{action:'call_this',visite:var_visite,tache:var_tache,utilisateur:var_user},
...
function var_code(trfx){
    ...
    document.getElementById('myIframe').classList.add('show')
        ...
        <div>
            <form name="frmSearch" method="post" action="">
                ...
                <table class='table table-bordered  table-responsive'>
                    <thead>
                        <tr>
                        <th width="1%">Nro</th><!--<th>ACF_ASSMBL_NAME</th>-->
                        <th width="2%">VIC status</th><!--<th>ACF_REGCOD_NOSPACE</th>-->
                        <th width="6%">Barcode WP</th><!--<th>ACF_REGCOD_NOSPACE</th>-->
                            <th width="15%">Work Package</th><!--<th>WORKPACK</th>-->
                            <th width="6%">Barcode TSK</th><!--<th>WORKPACK_BARCODE</th>-->
                            ...
                            <th  width="10%">STATUS_AP_BT</th><!--<th>WORKPACK_BARCODE</th>-->
                            <th  width="8%">Flag Risque</th><!--<th>WORKPACK_BARCODE</th>-->
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><a href="http://mtx.af-klm.com/maintenix/servlet/ScanBarcode?aBarcodeScan=<?php echo $result[$key]['WORKSCOPE_BARCODE']; ?>" target="_blank"><?php echo $result[$key]['WORKSCOPE_BARCODE']; ?></a></td>
                                        ...
                                        <td><?php echo $result[$key]['FLAG_INT']; ?></td>
...
<table id="table" 
	...
	<thead>
		<tr>
            ...
            <!--<th width="5%">Risque BT</th> <th>WORKPACK_BARCODE</th>-->
            <th  width="15%">Comment VIC</th><!--<th>WORKPACK_BARCODE</th>-->
            <th  width="10%">Status BT</th><!--<th>WORKPACK_BARCODE</th>-->
            <th  width="8%" data-formatter="ChampsHistoBT" data-sortable="true">Histo BT</th><!--<th>WORKPACK_BARCODE</th>-->
            <th  width="8%" data-sortable="true">Jours pris par BT</th><!--<th>WORKPACK_BARCODE</th>-->
            <th>Test</th><!--<th>TEST</th>-->
		</tr>
	</thead>
	<tbody>
...
function LinkFormatter(value, row) {
  ...
  function ChampsHistoBT(value, row) {
    ...
    return '<a id=historique href=# onclick=histo_code("'+ WORKSCOPE_BARCODE+'")>' + value + '</a>'
  }
